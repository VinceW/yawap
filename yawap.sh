...
# WLAN_DEVICE
# Uncomment th device on which Internet is available
WLAN_DEVICE="eth0"
#WLAN_DEVICE="eth1"
...
iptables -t nat -F
iptables -F
iptables -t nat -A POSTROUTING -o $WLAN_DEVICE -j MASQUERADE
iptables -A FORWARD -i $AP_DEVICE -o $WLAN_DEVICE -j ACCEPT
